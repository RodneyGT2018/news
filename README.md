...
App Link:  https://news-from-npr.herokuapp.com/
...
After clicking the "Let's Scrape" button on the right side of the navigation bar at the top, the screen delivers the results in the form of cards:
...
After closing the slide card shown above, the user can then click "Link to Article" to access the entire artice from the NPR website:
...
For all articles that the user wishes to save, the red button on the face of the article card can be clicked and the following message will appear:
...
To view all saved articles, the user will click "Saved Articles" found on the left side of the top navigation bar to pull up a sliding modal.  Also notice the green icon on the right side of each listed article that allows the user to delete a saved article.
